...
$markdown.Add('- Startup uses in-memory defaults and skips provider/network, audio, and config load/save.')
$markdown.Add("- Idle: starts after the first visible frame and samples the settled Home surface for $IdleSeconds seconds. Provider/network, audio, animations, and config I/O are suppressed.")
